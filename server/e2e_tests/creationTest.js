...
test('Login', async t => {
    await t
        ...
        .click('body > div.MuiPopover-root > div.MuiPaper-root.MuiPopover-paper.MuiPaper-elevation8.MuiPaper-rounded > div > ul > div > li > div.MuiListItemText-root > span')
        .wait(1000)
        .setNativeDialogHandler(() => true)
        .click('body > div.MuiDialog-root > div.MuiDialog-container.MuiDialog-scrollPaper > div > div.MuiDialogContent-root > div > div.removeListingButtonGroup > div.removeListingButton > button > span.MuiIconButton-label > svg')
        .click('body > div.MuiDialog-root > div.MuiDialog-container.MuiDialog-scrollPaper > div > div.MuiDialogTitle-root.profile-title > h2 > button > span.MuiIconButton-label > svg')
       .wait(3000)
})
