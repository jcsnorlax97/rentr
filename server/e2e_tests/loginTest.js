...
test('Login Successfully', async t => {
    await t
        ...
        .typeText('[id="loginEmail"]', 'demo1@gmail.com')
        .typeText('[id="loginPassword"]', 'demoing')
        ...
        .expect(Selector('#homePage_Header > div > button > span.MuiButton-label').textContent).contains('Good', 'Missing Profile Section')
})